...
export interface ChartProps { id: string; component?: 'Chart'; chartType: ChartType; title?: Dynamic<string>; subtitle?: Dynamic<string>; dataPath?: string; categoryKey?: string; valueKey?: string; parentKey?: string; dateKey?: string; series?: SeriesConfig[]; scenarios?: ProjectionScenario[]; sankeyNodesPath?: string; sankeyLinksPath?: string; waterfallStartLabel?: Dynamic<string>; waterfallEndLabel?: Dynamic<string>; gaugeMin?: Dynamic<number>; gaugeMax?: Dynamic<number>; gaugeValue?: Dynamic<number>; thresholds?: ThresholdBand[]; bulletValue?: Dynamic<number>; bulletTarget?: Dynamic<number>; benchmarkSeries?: SeriesConfig; stacked?: Dynamic<boolean>; showLegend?: Dynamic<boolean>; xAxisLabel?: Dynamic<string>; yAxisLabel?: Dynamic<string>; valueFormat?: ValueFormat; currency?: string; colorPositive?: string; colorNegative?: string; action?: ChartAction; data?: Record<string, unknown>; height?: number; className?: string; onAction?: (event: ChartAction['event'], datum: RecordRow) => void; onAskMaya?: (prompt: string) => void }
