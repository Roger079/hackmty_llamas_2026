...
export const ConfirmationReceipt: React.FC<ConfirmationReceiptProps> = ({
  ...
  return (
    <div className="bg-white text-slate-900 rounded-3xl shadow-2xl border border-slate-200 overflow-hidden my-3 animate-in zoom-in-95 duration-200">
      {/* Green Success Header */}
      <div className="bg-[#008744] text-white p-5 flex items-center justify-between">
      ...
      <div className="bg-slate-50 p-5 text-center border-b border-slate-200/70">
        <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Tu nueva cuota fija mensual</span>
      ...
      <div className="p-5 space-y-3 text-xs">
        ...
        <div className="flex justify-between items-center py-1">
          ...
          <span className="font-mono text-[10px] text-slate-400 truncate max-w-[180px]">{bankSeal}</span>
        </div>
      </div>
      ...
      <div className="p-4 bg-slate-50 border-t border-slate-200/80 flex gap-3">
        <button
          ...
          className="flex-1 py-3 rounded-xl border border-slate-300 font-bold text-xs text-slate-700 hover:bg-slate-100 transition flex items-center justify-center gap-2 cursor-pointer"
        >
        ...
        <button
          ...
          className="flex-1 py-3 rounded-xl bg-[#EB0029] hover:bg-[#C70023] font-bold text-xs text-white transition flex items-center justify-center gap-2 cursor-pointer shadow-md shadow-red-500/20"
        >
